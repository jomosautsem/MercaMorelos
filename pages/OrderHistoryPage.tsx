...
const OrderHistoryPage: React.FC = () => {
        ...
        return (
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center">
                <div className="py-20">
                    ...
                    <Link to="/" className="bg-primary text-slate-900 font-bold py-3 px-8 rounded-full hover:bg-primary-focus transition-all duration-300 transform hover:scale-105 shadow-lg shadow-primary/20">
                        Empezar a Comprar
                    </Link>
                </div>
            </div>
    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="bg-surface rounded-lg shadow-md overflow-hidden border border-border-color">
                            ...
                            <Link to={`/orders/${order.id}`} className="block hover:bg-surface-light/50 transition-colors duration-200">
                                <div className="p-4 sm:p-6">
                                    <div className="flex items-center justify-between">
                                        <p className="text-sm font-bold text-primary-focus truncate">
                                            Pedido #{order.id}
                                        </p>
